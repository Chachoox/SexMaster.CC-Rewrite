...
public class NiggerShader {
    ...
    public NiggerShader(String fragmentShaderLocation) throws IOException {
        ...
        this.timeUniform = glGetUniformLocation(program, "iTime");
       // this.mouseUniform = glGetUniformLocation(program, "imouse");
        this.resolutionUniform = glGetUniformLocation(program, "iResolution");
