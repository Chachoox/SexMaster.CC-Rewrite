        ...
        try {
            ModuleManager.getInstance().getModules()
                    ...
                    .ifPresent(module -> {
                        ...
                        ChatUtil.printString(ChatFormatting.GREEN + module.getName() + " was bound to " + Keyboard.getKeyName(Keyboard.getKeyIndex(args[2].toUpperCase())));
                    });
        } catch (Exception ex) {
            ChatUtil.printString(ChatFormatting.RED + ex.getMessage(), -4);
        }
    }
