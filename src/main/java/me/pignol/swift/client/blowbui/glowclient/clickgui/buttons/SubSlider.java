...
public class SubSlider extends BaseButton {
   ...
   public void draw(int mouseX, int mouseY) {
      ...
      RenderUtil.drawRect(getX(), getY(), getX() + getWidth(), getY() + getHeight(), Colors.toRGBA(0, 0, 0, 0));
      RenderUtil.drawRect(getX(), getY(), getX() + currentWidth, getY() + getHeight(), getColor());
   ...
   protected void getWidthFromValue() {
      ...
      val /= getMax() - getMin();
      val *= 92.0F;
      currentWidth = (int) GuiUtils.reCheckSliderRange(val, 0.0F, 92.0F);
   }
